...
class Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
      ...
      double secondRadius = 3 * radius / 5;
      double minuteRadius = 2.5 * radius / 5;
      double hourRadius   = 2 * radius / 5;
      ...
      double outerCircleRadius      = newRadius;
      double bigInnerCircleRadius   = newRadius - 8;
      double smallInnerCircleRadius = newRadius - 25;
